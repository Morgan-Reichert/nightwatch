      ...
      >
        ...
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold tracking-tighter">
            <span className="gradient-text">Nightwatch</span>
          </h1>
          <p className="text-muted-foreground text-sm">Stay sharp. Stay safe. 🌙</p>
        </div>
        ...
        <div className="glass-card p-1 flex">
          {['Connexion', 'Inscription'].map((label, i) => (
            <motion.button
              ...
              className={`flex-1 py-3 rounded-[20px] text-sm font-medium transition-all ${
                (i === 0 ? isLogin : !isLogin)
        ...
        <div className="grid grid-cols-2 gap-3">
          <motion.button
            ...
            className="glass-card flex items-center justify-center gap-2 py-3 rounded-2xl hover:bg-white/5 transition-colors"
          >
